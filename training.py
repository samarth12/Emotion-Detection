...
tf.flags.DEFINE_string("positive_data", "./data/rt-polaritydata/rt-polarity.pos", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data", "./data/rt-polaritydata/rt-polarity.neg", "Data source for the negative data.")
...
def preprocess():
    print("Loading data...")
    x_text, y = preprocessing.load_data()
    y.reshape((1, -1))
    print(y)
